# Generated by Django 3.0.6 on 2021-09-19 00:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('validade', models.CharField(blank=True, choices=[('Quinze', '15 (Quinze)'), ('Trinta', '30 (Trinta)'), ('Sessenta', '60 (Sessenta)'), ('Noventa', '90 (Noventa)')], max_length=200, verbose_name='Validade')),
                ('valor', models.DecimalField(decimal_places=2, max_digits=8, verbose_name='Valor a pagar')),
                ('situacao', models.CharField(choices=[('Atrasado', 'Atrasado'), ('AVencer', 'À Vencer'), ('Pago', 'Pago')], max_length=200, verbose_name='Situação')),
                ...
                ('loguin', models.CharField(blank=True, max_length=30, verbose_name='Login')),
